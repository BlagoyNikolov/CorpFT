                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" style="width: 100%;"
                                ...
                                <option selected="selected"><c:out value="${ editTransactionCurrency }"></c:out></option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" style="width: 100%;"
                                ...
                                <option selected="selected"><c:out
                                        value="${ editTransactionCategory }"></c:out></option>
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group date">
                                ...
                                <fmt:parseDate value="${ editTransactionDate }" pattern="yyyy-MM-dd'T'HH:mm"
                    ...
                    <form action="deleteTransaction/${transactionId}" method="post" id="deleteForm">
                        <div class="box-footer">
                            <input id="submitBtn" type="button" name="btn" data-toggle="modal"
                                   ...
                                   value="Delete transaction"></input>
                        </div>
                    </form>
                </c:if>
            </div>
